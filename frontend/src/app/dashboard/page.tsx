              ...
              <Link href="/providers">
                <Button variant="outline" className="h-auto p-4 w-full">
                  <div className="text-center">
                    ...
                    <div className="font-medium">添加服务商</div>
                    <div className="text-sm text-gray-500">配置DNS服务商</div>
                  </div>
                </Button>
              </Link>
              ...
              <Link href="/domains">
                <Button variant="outline" className="h-auto p-4 w-full">
                  <div className="text-center">
                    ...
                    <div className="font-medium">管理域名</div>
                    <div className="text-sm text-gray-500">添加或管理域名</div>
                  </div>
                </Button>
              </Link>
              ...
              <Link href="/dns-records">
                <Button variant="outline" className="h-auto p-4 w-full">
                  <div className="text-center">
                    ...
                    <div className="font-medium">DNS记录</div>
                    <div className="text-sm text-gray-500">管理DNS记录</div>
                  </div>
                </Button>
              </Link>
              ...
              <Link href="/profile">
                <Button variant="outline" className="h-auto p-4 w-full">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-500">账户设置</div>
                  </div>
                </Button>
              </Link>
            </div>
